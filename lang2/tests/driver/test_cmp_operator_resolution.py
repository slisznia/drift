...
def test_eq_uses_std_core_cmp_without_std_algo(tmp_path: Path) -> None:
...
implement cmp.Equatable for Foo {
	pub fn eq(self: &Foo, other: &Foo) -> Bool { return self.x == other.x; }
}
