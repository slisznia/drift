...
""",
	...
	has_cap = any(d.code == "E_REQUIREMENT_NOT_SATISFIED" and "BinarySearchable" in d.message for d in diagnostics)
	has_cmp = any(d.code == "E_REQUIREMENT_NOT_SATISFIED" and "Comparable" in d.message for d in diagnostics)
...
""",
	...
	has_perm = any(d.code == "E_REQUIREMENT_NOT_SATISFIED" and "Permutable" in d.message for d in diagnostics)
	has_cmp = any(d.code == "E_REQUIREMENT_NOT_SATISFIED" and "Comparable" in d.message for d in diagnostics)
...
""",
	...
	assert any(d.code == "E_REQUIREMENT_NOT_SATISFIED" and "Permutable" in d.message for d in diagnostics)
